...
for i in range(num_items):
    for j in range(i+1, num_items):
        ...
        #Calculate angle in degrees between two columns of matrix
    ...
    for line in f:
        ...
        for item_id in shopping_cart:
            ...
            if best_angle < 90 and best_angle > 0:
                ...
                recommended_items[best_match] = min(recommended_items.get(best_match, 90), best_angle)
            else:
